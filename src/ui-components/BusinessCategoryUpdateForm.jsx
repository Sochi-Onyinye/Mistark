...
export default function BusinessCategoryUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = businessCategoryRecord
      ? { ...initialValues, ...businessCategoryRecord }
      : initialValues;
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            BusinessCategory.copyOf(businessCategoryRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "BusinessCategoryUpdateForm")}
      {...rest}
    >
      <TextField
        label="Category name"
